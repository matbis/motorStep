...
void stepperMotor(bit doStep_in, bit doRewind_in, bit stopRewind_in, int nSteps_in, int delayDuration_in, bit *a_out, bit *b_out, bit *c_out, bit *d_out, bit *stepDone_out);
